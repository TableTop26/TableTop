...
// Temporary fixed restaurant ID until full RBAC provides context.
// Should match what we use in dashboard menu for testing.
...
export default function KitchenPage() {
  const openOrders = useQuery(api.orders.getOpenKitchenTickets, {
      ...
      <CardContent className="p-3">
        <ul className="space-y-2 text-sm">
          {order.items.map((item: OrderItem, i: number) => (
            <li key={i} className="flex flex-col border-b border-dashed pb-2 last:border-0 last:pb-0">
